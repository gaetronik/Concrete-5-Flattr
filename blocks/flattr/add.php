...
<?php echo $form->text('title', $c->getCollectionName(), array('style' => 'width: 320px'));?>
<?php echo $form->label('url', 'URL');?>
<?php echo $form->text('url', "http://".$_SERVER['HTTP_HOST'].$c->getCollectionPath(), array('style' => 'width: 320px'));?>
<?php echo $form->label('description', 'description');?>
<?php echo $form->text('description', $c->getCollectionDescription(),array('style' => 'width: 320px'));?>
<?php echo $form->label('tags', 'tags');?>
<?php echo $form->text('tags', $c->getCollectionAttributeValue('meta_keywords'));?>
<?php echo $form->label('hidden', 'hide');?>
<?php echo $form->checkbox('hidden','hidden',false );?>
<?php echo $form->label('uid', 'flatter uid');?>
<?php echo $form->text('uid' );?>
<?php echo $form->label('category', 'Category');?>
<?php 
$catJS='{"text":"Written text","images":"Images","video":"Video","audio":"Audio","software":"Software","rest":"The rest"}';
echo $form->select('category', json_decode($catJS,TRUE), 'text');?>
...
echo $form->select('language',$langs , $def);?>
